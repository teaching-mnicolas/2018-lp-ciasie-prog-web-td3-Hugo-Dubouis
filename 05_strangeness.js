describe ("Strangeness", function() {
  ...
  describe ("Mutables", function() {
    it ("{} is of type Object", function() {
      expect(({}) instanceof Object).toBe(true);      // true or false
    });

    it ("[] is of type Array", function() {
      expect([] instanceof Array).toBe(true);       // true or false
    });
    ...
    it ("/aaa/ is of type RegExp", function() {
      expect(/aaa/ instanceof RegExp).toBe(true);   // true or false
    });

    it ("/aaa/ is of type Object also", function() {
      expect(/aaa/ instanceof Object).toBe(true);   // true or false
    });

    it ("f is of type Function", function() {
      const f = function() {};
      expect(f instanceof Function).toBe(true);     // true or false
    });

    it ("f is of type Object also", function() {
      const f = function() {};
      expect(f instanceof Object).toBe(true);       // true or false
    });
  });
  ...
  describe ("Immutables", function() {
    ...
    describe ("Number", function() {
      ...
      it ("1 is NOT instance of Number", function() {
        expect(1 instanceof Number).toBe(false);     // true or false
      });

      it ("1 is NOT instance of Object", function() {
        expect(1 instanceof Object).toBe(false);     // true or false
      });

      it ("but new Number is a Number", function() {
        const n = new Number();
        expect(n instanceof Number).toBe(true);     // true or false
      });
    });
    ...
    describe ("String", function() {
      ...
      it ("'' is NOT instance of String", function() {
        expect('' instanceof String).toBe(false);    // true or false
      });

      it ("'' is NOT instance of Object", function() {
        expect('' instanceof Object).toBe(false);    // true or false
      });

      it ("but new String is a String", function() {
        const s = new String();
        expect(s instanceof String).toBe(true);     // true or false
      });
    });
    ...
    describe ("Boolean", function() {
      ...
      it ("true is NOT instance of Boolean", function() {
        expect(true instanceof Boolean).toBe(false);   // true or false
      });

      it ("true is NOT instance of Object", function() {
        expect(true instanceof Object).toBe(false);    // true or false
      });

      it ("but new Boolean is a Boolean", function() {
        const b = new Boolean();
        expect(b instanceof Boolean).toBe(true);      // true or false
      });
    });
  ...
  describe ("Specials", function() {
    ...
    describe ("Infinity", function() {
      ...
      it ("Infinity is NOT instance of Number", function() {
        expect(Infinity instanceof Number).toBe(false);      // true or false
      });

      it ("Infinity is NOT instance of Object", function() {
        expect(Infinity instanceof Object).toBe(false);      // true or false
      });
    });
    ...
    describe ("NaN", function() {
      ...
      it ("NaN is NOT instance of Number", function() {
        expect(NaN instanceof Number).toBe(false);         // true or false
      });

      it ("NaN is NOT instance of Object", function() {
        expect(NaN instanceof Object).toBe(false);         // true or false
      });
    });
    ...
    describe ("undefined", function() {
      ...
      it ("undefined is NOT instance of Object", function() {
        expect(undefined instanceof Object).toBe(false);   // true or false
      });
    });
    ...
    describe ("null", function() {
      ...
      it ("null is NOT instance of Object", function() {
        expect(null instanceof Object).toBe(false);        // true or false
      });
    });
